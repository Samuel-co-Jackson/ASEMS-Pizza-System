...
<body>
    <form id="form1" runat="server">
        ...
        <asp:Button ID="btnOK" runat="server" OnClick="btnOK_Click" style="z-index: 1; left: 158px; top: 521px; position: absolute; width: 94px" Text="OK" />
        <asp:Button ID="btnCancel" runat="server" style="z-index: 1; left: 262px; top: 521px; position: absolute; width: 94px" Text="Cancel" OnClick="btnCancel_Click" />
        ...
        <asp:TextBox ID="txtFirstname" runat="server" style="z-index: 1; left: 209px; top: 78px; position: absolute; width: 155px; text-align: left"></asp:TextBox>
        ...
        <asp:Label ID="lblError" runat="server" style="z-index: 1; left: 96px; top: 370px; position: absolute; width: 578px; height: 74px;"></asp:Label>
    </form>
</body>
</html>
